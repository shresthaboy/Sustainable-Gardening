    ...
    <div className="container-fluid text-center about-container">
      <div className="row">
        <div className="col-md-12 about-first">
          <h1 className="about-title">Plantae</h1>
          <p>
        ...
        <div className="team row div-dev" >
          ...
          <div className="col-md-3 col-12 text-center">
            <div className="card mr-2 d-inline-block shadow-lg">
              <div className="card-img-top">
                <img
                  src="images/sabin.jpg"
                  alt="member"
                  className="img-fluid rounded-circle w-50.5 p-4"
                />
              </div>
              <div className="card-body">
                <h3 className="card-title">Sabin Shrestha</h3>
                <p className="text-black-50">Student at Kathmandu Bernhardt College</p>
              </div>
            </div>
          </div>
          <div className="col-md-3 text-center">
            <div className="card mr-2 d-inline-block shadow-lg">
              <div className="card-img-top">
                <img
                  src="images/richa.jpg"
                  alt="member"
                  className="img-fluid rounded-circle w-55 p-4"
                />
              </div>
              <div className="card-body">
                <h3 className="card-title">Richa Rai</h3>
                <p className="text-black-50">Student at Kathmandu Bernhardt College</p>
              </div>
            </div>
          </div>
